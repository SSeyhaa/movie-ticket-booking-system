 ...
 */
package com.legend.common_util.core.chain.base;

import com.legend.common_util.core.chain.Catalog;
import com.legend.common_util.core.chain.CatalogFactory;
import com.legend.common_util.core.chain.Chain;
import com.legend.common_util.core.chain.ChainException;
import com.legend.common_util.core.chain.Command;
import com.legend.common_util.core.chain.Context;
import com.legend.common_util.core.chain.Filter;
import com.legend.common_util.core.chain.Processing;
import com.legend.common_util.core.chain.impl.CatalogFactoryBase;
...
public class LookupCommand<K, V, C extends Map<K, V>> implements Filter<K, V, C> {
     ...
     * @throws ChainException if and error occurs in the looked-up Command.
     */
